 ...
 * @param u32_tick_ms the no to wait for
 */
void mcal_sysTick_set(uint32_t u32_tick_ms)
{
    uint32_t u32_temp = 0;
    ...
    if (u32_tick_ms == 1)
    {
        ...
        u32_temp = (u32_tick_ms * F_CPU / (64UL * 1000UL)) - 1;
    ...
    else
    {
        ...
        u32_temp = (u32_tick_ms * F_CPU / (1024UL * 1000UL));
